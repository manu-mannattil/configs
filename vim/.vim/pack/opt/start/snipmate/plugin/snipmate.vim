...
command! -nargs=? ResetSnippets :call ResetSnippets(<q-args>)
command! ResetAllSnippets :call ResetAllSnippets()
command! -nargs=? ReloadSnippets :call ReloadSnippets(<q-args>)
