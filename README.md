...
This is a repository for managing my configuration files (aka dotfiles), meticulously yak shaved since 2010 or so and contains about <!--FILES-->223 configuration files for about <!--PROGRAMS-->60
