...
export HISTIGNORE="bg:clear:fg:history:ls:rm *:aria2c *:find *-delete*:ffind *-delete*:youtube-dl *:yt-dlp *:curl2aria2c *"
...
alias axel='axel -n 4 -a -U "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36"'
